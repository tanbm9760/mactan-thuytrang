  ...
  vi: {
    ...
    story: {
      ...
      paragraphs: [
        ...
        'Từ những cuộc trò chuyện ban đầu, những lần gặp gỡ giản dị, chúng mình dần hiểu nhau hơn, thương nhau nhiều hơn, rồi tự nhiên trở thành một phần trong cuộc sống của nhau. Và tháng 12 năm ấy, chúng mình chính thức bắt đầu.',
        ...
        'Từ ngày ấy đến hôm nay, sau tất cả những mùa đã cùng nhau đi qua, chúng mình biết rằng người mình muốn đồng hành trong những năm tháng phía trước vẫn là người đang đứng cạnh mình lúc này.',
      ],
      closing:
  ...
  en: {
    ...
    story: {
      ...
      paragraphs: [
        ...
        'From those first conversations and simple meetings, we came to understand each other more, to love each other more, and quite naturally became part of each other\'s lives. And by December that year, we began, for real.',
        ...
        'From that day to this, after every season we have walked through together, we know that the person we want beside us for the years ahead is the one standing beside us right now.',
      ],
      closing:
